    ...
    <nav class="navbar navbar-expand-sm bg-light" ></nav>
        ...
        <div class="container">
            <div>
                ...
                <p>Two-wheeler insurance is a type of insurance that is mandatory in India. Falling under the<br> General insurance product category, it helps protect people against accidents that take place on the road.</p>
            </div>
            <div class="jumbotron" style="display:inline-block;background-color: whitesmoke;width:100%;">
            <span style="display: inline-block;">
            <h2 style="font-size: 35px;">Get your Bike Insurance done in no time!</h2>
            <h3>Welcome Back,<br><br>
                Choose your two wheeler Insurance Plans from<br> top Insurers starting at Rs 800/- for 3 years!</h3><br>
                <form action="#" method="post">
                    <label for="Vehicle number" style="display: block;margin-bottom: 8px;padding-top: 10px;">Enter Vehicle Number:</label>
                    <input type="text" style="width: 100%;padding: 10px;margin-bottom: 15px;border:none;border-radius: 4px;box-sizing: border-box;border-bottom:3px solid #ccc;margin-top: 15px;"id="userQuestion" name="userQuestion" placeholder="Bike Number..." required>
                ...
                <a href="2 wheeler plans.php" class="btn btn-success">View Plans</a>
            ...
            <img src="bike.png" alt="" style="float: right;width: 300px;margin-top: 25px;">
            </div>
