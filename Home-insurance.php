    ...
    <nav class="navbar navbar-expand-sm bg-light" ></nav>
        ...
        <div class="container">
            <div>
                ...
                <p>Homeowners insurance is a form of property insurance that covers losses and damages to an individual's residence,<br> along with furnishings and other assets in the home. Homeowners insurance also provides liability coverage against accidents in the home or on the property.</p>
            </div>
            <div class="jumbotron" style="display:inline-block;background-color: whitesmoke;width:100%;">
            <span style="display: inline-block;">
            <h2 style="font-size: 35px;">Make sure your home is a breeze</h2>
            <h3>Welcome Back,<br><br>
                Choose the Best Home Insurance Plans from<br> top Insurers according to your area starting from<br> ₹ 35/month with Total premium for 10 years at ₹ 4,248</h3><br>
                <a href="Home plans.php" class="btn btn-warning">View Plans</a>
            ...
            <img src="home insurance icon.png" alt="" style="float: right;width: 300px;margin-top: 25px;">
            </div>
