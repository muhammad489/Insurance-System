...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <nav class="navbar navbar-expand-sm bg-light" ></nav>
        ...
        <div id="interestForm">
            <h2 style="background-color: MediumSeaGreen;color:white;padding:7px;border-radius: 20px;margin-top: -10px;">Interest Calculator</h2>
    
            <label for="principal">Principal Amount:</label>
            <input type="number" id="principal" placeholder="Enter principal amount" style="background-color:white;border:none;border-radius: 10px;" required>
            ...
            <input type="number" id="time" placeholder="Enter time in years" style="background-color:white;border:none;border-radius: 10px;" required>
            ...
            <img src="interest calculator.png" style="width:300px;display: inline-block;margin-top: -250px;margin-left: 50px;">
        </form>
        </div>
        ...
        <script>
            function calculateInterest() {
                ...
                var simpleInterest = (principal * interestRate * time).toFixed(2);
                var compoundInterest = (principal * Math.pow(1 + interestRate, time) - principal).toFixed(2);
    
                document.getElementById('result').innerHTML = 'Simple Interest: ₹' + simpleInterest + '<br>Compound Interest: ₹' + compoundInterest;
            }
        </script>
