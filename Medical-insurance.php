    ...
    <nav class="navbar navbar-expand-sm bg-light" ></nav>
        ...
        <div class="container">
            <div>
                ...
                <p>Health insurance or medical insurance is a type of insurance that covers the whole or a part of the risk of a person<br> incurring medical expenses. As with other types of insurance, risk is shared among many individuals.</p>
            </div>
            <div class="jumbotron" style="display:inline-block;background-color: whitesmoke;width:100%;">
            <span style="display: inline-block;">
            <h2 style="font-size: 35px;">Secure your Health with 1 crore cover<br> starting at ₹15/day</h2>
            <h3>Welcome Back,<br><br>
                Choose the Best Health Insurance Plans from<br> top Insurers starting at ₹450/month</h3><br>
                <a href="Medical plans.php" class="btn btn-success">View Plans</a>
            ...
            <img src="Medical insurance.png" alt="" style="float: right;width: 300px;margin-top: 25px;">
            </div>
