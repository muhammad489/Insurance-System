    ...
    <nav class="navbar navbar-expand-sm bg-light" ></nav>
        ...
        <div class="container">
            <div>
                ...
                <p>Vehicle insurance is insurance for cars, trucks, motorcycles, and other road vehicles. Its primary use<br>is to provide financial protection against physical damage or bodily injury resulting from traffic collisions<br> and against liability that could also arise from incidents in a vehicle.</p>
            </div>
            <div class="jumbotron" style="display:inline-block;background-color: whitesmoke;width:100%;">
            <span style="display: inline-block;">
            
            <h2 style="font-size: 35px;">Choose your vehicle:</h2><br>
            <div class="dropdown">
                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                  Choose-Vehicle
                </button>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="2wheeler-insurance.php">2 Wheeler</a>
                  <a class="dropdown-item" href="4Wheeler-insurance.php">4 Wheeler</a>
            ...
            <img src="vehicles.png" alt="" style="float: right;width: 300px;margin-top: 25px;">
            </div>
