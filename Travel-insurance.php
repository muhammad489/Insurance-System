    ...
    <nav class="navbar navbar-expand-sm bg-light" ></nav>
        ...
        <div class="container">
            <div>
                ...
                <p>Travel Insurance is a type of insurance that covers different risks while travelling. It covers medical expenses,<br> lost luggage, flight cancellations, and other losses that a traveller can incur while travelling. Travel Insurance is<br> usually taken from the day of travel till the time the traveller reaches back to India.</p>
            </div>
            <div class="jumbotron" style="display:inline-block;background-color: whitesmoke;width:100%;">
            <span style="display: inline-block;">
            <h2 style="font-size: 35px;">Secure your Travel with the best<br> policies we have to offer!</h2>
            <h3>Welcome Back,<br><br>
                Help us secure your travel</h3><br>
                <a href="travel plans.php" class="btn btn-info">View Plans</a>
            ...
            <img src="travel insurance.png" alt="" style="float: right;width: 300px;margin-top: 25px;">
            </div>
